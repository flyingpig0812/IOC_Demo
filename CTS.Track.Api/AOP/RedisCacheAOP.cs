...
using CTS.Track.Common.Attributes;
...
namespace CTS.Track.Api.AOP
{
    ...
    public class RedisCacheAOP : CacheAOPbase
    {
        ...
        public override void Intercept(IInvocation invocation)
        {
            ...
            {
                //获取自定义缓存键
                var cacheKey = qCachingAttribute.CustomKeyValue == null ? CustomCacheKey(invocation) : qCachingAttribute.CustomKeyValue;
